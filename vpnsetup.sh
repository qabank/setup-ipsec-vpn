...
YOUR_IPSEC_PSK='vbxocxaa'
YOUR_USERNAME='qabank'
YOUR_PASSWORD='vbxocxaa'
...
get_setup_url() {
  base_url1="https://github.com/qabank/setup-ipsec-vpn/raw/master"
  base_url2="https://gitlab.com/qabank/setup-ipsec-vpn/-/raw/master"
